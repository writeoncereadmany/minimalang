...
public class TypeCheckerTest {
    ...
    public static final NamedType successType = new NamedType("Success");
    public static final NamedType number = new NamedType("Number");
    public static final NamedType string = new NamedType("String");
